...
(function (L4_Canvas) {
    ...
    function init(_event) {
        ...
        for (var i = 0; i < 50; i++) {
            ...
            var randomY = (Math.random() * (540 - 450) + 450);
            switch (random) {
                case 0:
    ...
    // BLume 2 
    function drawFlower2(_x, _y, _r, _fillColor) {
        crc2.beginPath();
    ...
    function flyBees() {
        ...
        for (var i = 0; i < n; i++) {
            ...
            y[i] += Math.random() * 4 - 2;
            if (x[i] < 0 - 10) {
                x[i] = canvas.width + 10; // +10 ist der Radius der Biene, damit es einen flie�eden �bergang gibt
            }
